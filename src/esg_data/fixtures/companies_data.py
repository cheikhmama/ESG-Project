...
INDICATOR_VALUES: dict[str, dict[str, float | None]] = {
    "SNIM": {
        "scope_1_intensity": 708.3,
        "scope_2_intensity": 100.0,
        "scope_3_intensity": 292.5,
        "climate_policy": 40.0,
        "renewable_energy_pct": 8.0,
        "water_intensity": 95.0,
        "water_recycling_pct": 22.0,
        "water_policy": 50.0,
        "land_use_impact": 85.0,
        "biodiversity_policy": 30.0,
        "waste_intensity": 180.0,
        "recycling_rate": 18.0,
        "employee_turnover": 12.5,
        "gender_pay_gap": 22.0,
        "training_hours": 28.0,
        "injury_rate": 8.5,
        "supply_chain_audit": 35.0,
        "human_rights_policy": 45.0,
        "child_labor_incidents": 0.0,
        "community_investment": 55.0,
        "local_procurement_pct": 62.0,
        "social_impact_programs": 50.0,
        "board_independence_pct": 40.0,
        "women_on_board_pct": 15.0,
        "ceo_chair_separation": 100.0,
        "board_esg_expertise": 30.0,
        "esg_reporting_quality": 45.0,
        "audit_independence": 60.0,
        "disclosure_score": 40.0,
        "anti_bribery_policy": 50.0,
        "whistleblower_policy": 40.0,
        "corruption_incidents": 1.0,
    },
    "SOMELEC": {
        "scope_1_intensity": 1388.9,
        "scope_2_intensity": 53.3,
        "scope_3_intensity": 211.1,
        "climate_policy": 30.0,
        "renewable_energy_pct": 12.0,
        "water_intensity": 120.0,
        "water_recycling_pct": 15.0,
        "water_policy": 35.0,
        "land_use_impact": 70.0,
        "biodiversity_policy": 25.0,
        "waste_intensity": 145.0,
        "recycling_rate": 12.0,
        "employee_turnover": 9.0,
        "gender_pay_gap": 28.0,
        "training_hours": 20.0,
        "injury_rate": 5.5,
        "supply_chain_audit": 25.0,
        "human_rights_policy": 40.0,
        "child_labor_incidents": 0.0,
        "community_investment": 60.0,
        "local_procurement_pct": 55.0,
        "social_impact_programs": 45.0,
        "board_independence_pct": 35.0,
        "women_on_board_pct": 10.0,
        "ceo_chair_separation": 100.0,
        "board_esg_expertise": 20.0,
        "esg_reporting_quality": 35.0,
        "audit_independence": 55.0,
        "disclosure_score": 30.0,
        "anti_bribery_policy": 40.0,
        "whistleblower_policy": 30.0,
        "corruption_incidents": 2.0,
    },
    "MAURITEL": {
        "scope_1_intensity": 87.5,
        "scope_2_intensity": 153.6,
        "scope_3_intensity": 228.6,
        "climate_policy": 60.0,
        "renewable_energy_pct": 18.0,
        "water_intensity": 12.0,
        "water_recycling_pct": 45.0,
        "water_policy": 65.0,
        "land_use_impact": 20.0,
        "biodiversity_policy": 55.0,
        "waste_intensity": 22.0,
        "recycling_rate": 42.0,
        "employee_turnover": 7.5,
        "gender_pay_gap": 15.0,
        "training_hours": 45.0,
        "injury_rate": 1.8,
        "supply_chain_audit": 55.0,
        "human_rights_policy": 65.0,
        "child_labor_incidents": 0.0,
        "community_investment": 70.0,
        "local_procurement_pct": 72.0,
        "social_impact_programs": 68.0,
        "board_independence_pct": 58.0,
        "women_on_board_pct": 25.0,
        "ceo_chair_separation": 100.0,
        "board_esg_expertise": 55.0,
        "esg_reporting_quality": 62.0,
        "audit_independence": 70.0,
        "disclosure_score": 58.0,
        "anti_bribery_policy": 70.0,
        "whistleblower_policy": 65.0,
        "corruption_incidents": 0.0,
    },
    "NEXT": {
        "scope_1_intensity": 22.3,
        "scope_2_intensity": 97.1,
        "scope_3_intensity": 178.6,
        "climate_policy": 75.0,
        ...
        "training_hours": 65.0,
        "injury_rate": 0.5,
        "supply_chain_audit": 70.0,
        "human_rights_policy": 80.0,
        "child_labor_incidents": 0.0,
        "community_investment": 75.0,
        "local_procurement_pct": 80.0,
        "social_impact_programs": 78.0,
        "board_independence_pct": 65.0,
        "women_on_board_pct": 33.0,
        "ceo_chair_separation": 100.0,
        "board_esg_expertise": 70.0,
        "esg_reporting_quality": 72.0,
        "audit_independence": 75.0,
        "disclosure_score": 68.0,
        "anti_bribery_policy": 80.0,
        "whistleblower_policy": 75.0,
        "corruption_incidents": 0.0,
    },
}
...
REFERENCE_PORTFOLIOS: list[dict[str, object]] = [
    {
        "id": "mauritania-diversified",
        "name": "Mauritania Diversified",
    ...
    {
        "id": "mauritania-esg-leaders",
        "name": "Mauritania ESG Leaders",
    ...
    {
        "id": "mauritania-infrastructure",
        "name": "Mauritania Infrastructure",
